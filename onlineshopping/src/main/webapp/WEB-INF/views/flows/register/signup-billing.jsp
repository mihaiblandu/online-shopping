					...
					<div class="panel-body">
						...
						>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:input type="text" path="postal_code" class="form-control"
										placeholder="XXXXXX" />
									<sf:errors path="postal_code" cssClass="help-block" element="em"/> 
								</div>
							</div>							
							...
							<div class="form-group">
								<div class="col-md-offset-4 col-md-8">
									<button type="submit" name="_eventId_start" class="btn btn-primary">
