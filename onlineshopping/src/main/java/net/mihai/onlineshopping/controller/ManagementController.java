...
import net.mihai.onlineshopping.util.FileUploadUtility;
import net.mihai.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public String managePostProduct(@Valid @ModelAttribute("product") Product mProduct, 
			BindingResult results, Model model, HttpServletRequest request) throws IOException {
